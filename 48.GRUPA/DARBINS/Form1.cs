    ...
    public partial class Form1 : Form
    {
        ...
        {   //izlemj vai iet cilvēks vai dators
            ...
            { // datora gājiens
                ...
                MessageBox.Show($"Algorithm Execution Time: {elapsed.TotalMilliseconds} milliseconds", "Time", MessageBoxButtons.OK, MessageBoxIcon.Information);
                ...
                label15.Text = VirsotnuSkaits.ToString();
            }
            //nosaka uzvarētajus
